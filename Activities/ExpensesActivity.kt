...
class ExpensesActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_expense) // Ensure this is the correct layout file
        ...
        incomeTextView.text = "$${String.format("%.2f", totalBalance)}"
        // Categories page
    ...
    private fun populateExpenses() {
        ...
        val expenses = mySQLiteHelper.getExpensesExcludingIncome()
