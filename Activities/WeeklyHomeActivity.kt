...
class WeeklyHomeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_home_weekly)
        window.setFlags(
        ...
        val foodExpenses = mySQLiteHelper.getTotalFoodExpensesLastWeek()
        ...
        btnWeekly.setOnClickListener {
            val expenses = mySQLiteHelper.getCurrentWeekExpenses()
            val adapter = HomeAdapter(this, expenses)
            listView.adapter = adapter
        }
